...
const COLS: Col[] = [
  ...
  { kind: 'phone', shot: { src: '/mockups/carestream-2026-mobile.jpg', alt: 'CareStream on mobile' } },
  { kind: 'stack', shots: [
    { src: '/mockups/carestream-2026.jpg', alt: 'CareStream', url: 'carestreamai.com' },
    { src: '/mockups/haywards-landing.png', alt: 'A care home landing page', url: 'careassura.com' },
  ] },
  { kind: 'phone', shot: { src: '/mockups/carestream-2026-pricing-mobile.jpg', alt: 'CareStream pricing on mobile' } },
  ...
  { kind: 'tablet', shot: { src: '/mockups/carestream-2026.jpg', alt: 'CareStream on a tablet', url: 'carestreamai.com' } },
