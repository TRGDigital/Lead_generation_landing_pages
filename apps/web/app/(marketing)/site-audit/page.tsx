...
const META: Metadata = {
  title: 'Care Website Audit | Full SEO, Speed & Accessibility Report',
  description:
    'A full audit of your care website: technical SEO, schema, alt text, internal links, page speed, accessibility, local content and more, written in plain English by a care sector specialist.',
  alternates: { canonical: `${SITE_URL}/site-audit` },
  robots: { index: true, follow: true },
}

export async function generateMetadata(): Promise<Metadata> {
  return applyPageSeo('/site-audit', META)
}
...
const FAQS: [string, string][] = [
  [
    'What does it cost?',
    'A fixed price for the whole audit, agreed with you before any work starts, so there is nothing open ended and no hourly rate. Ask for a quote and we will confirm the price for your site. If you would like something free first, the website grader gives you an instant score at no charge.',
  ],
  [
    'Am I committed to anything afterwards?',
    'No. The report is yours to keep and act on however you like, including handing it to whoever built your site. Some people do the work themselves, some ask us. Both are genuinely fine.',
  ],
  [
    'Is it automated?',
  ...
  return (
    <>
      <ServiceLanding
        ...
        schemaDescription="A technical SEO, speed, accessibility and conversion audit of a care provider's website, written by a care sector specialist."
        eyebrow="Independent and thorough"
        title={['A full audit of your', 'entire website,', 'written by a human']}
        intro={`We go through your website the way Google, a screen reader and a worried family all see it, then send you a written report: what is wrong, what it is costing you, and what we would fix first. ${totalChecks} checks across ${GROUPS.length} areas, and not one of them is a sales pitch.`}
        heroPoints={[
          ...
          'Yours to keep and act on, whether you go on to work with us or not',
        ]}
        primaryCta={{ label: 'Request an audit', href: '#request' }}
        secondaryCta={{ label: 'Score your site free, instantly', href: '/tools/website-grader' }}
        mock={{
        ...
        why={{
          title: 'Why start with an audit',
          tagline: 'Because guessing is the expensive part',
          paragraphs: [
            <>
            ...
            <>
              ...
              and we hand it over. The report is yours: fix it yourself, hand it to whoever built your site, or ask us
              to do the work. There is no obligation either way, and nothing in it is a sales pitch.
            </>,
          ],
        }}
        points={[
          ...
          'A fixed price agreed before we start, and no obligation afterwards',
        ]}
        pointsCta="Request an audit"
        cards={{
              ...
              <div className="mx-auto grid max-w-5xl gap-10 lg:grid-cols-[1.1fr_1fr]">
                <div>
                  ...
                  <p className="mt-4 text-base leading-relaxed text-brand-ink-soft">
                    ...
                    site, your hosting or your analytics, nothing changes on your website as a result of asking, and we
                    confirm the price before any work starts.
                  </p>
        ...
        cta={{
          ...
          body: 'One form, a few working days, and an honest report on every part of your site. A fixed price agreed up front, and no obligation at the end of it.',
        }}
      />
    </>
  )
