...
export async function generateMetadata(): Promise<Metadata> {
  return applyPageSeo('/tools/funding-calculator', META)
}

const META: Metadata = {
  title: 'Free Care Funding Calculator | Care Home Costs & Funding',
  description:
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: `${SITE_URL}/tools/funding-calculator`,
            applicationCategory: 'FinanceApplication',
            operatingSystem: 'Web',
            description: 'Free tool to estimate what a family will pay towards care and what the council or NHS may cover.',
